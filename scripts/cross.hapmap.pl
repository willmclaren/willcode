...
open IN, $args{'s1'} or die "Could not open file $args{'s1'}\n";
while(<IN>) {
	chomp;
...
open IN, $args{'s2'} or die "Could not open file $args{'s2'}\n";
while(<IN>) {
	chomp;
...
open IN, $args{'l1'} or die "Could not open file $args{'l1'}\n";
while(<IN>) {
	chomp;
	next if /^rs$/;
	next if /position/;
...
open IN, $args{'l2'} or die "Could not open file $args{'l2'}\n";
while(<IN>) {
	chomp;
	next if /^rs$/;
	next if /position/;
...
open IN, $args{'p1'} or die "Could not open file $args{'p1'}\n";
...
open IN, $args{'p2'} or die "Could not open file $args{'p2'}\n";
